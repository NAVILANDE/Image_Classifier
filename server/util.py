# how can uI send the img to backend 
# can be done by 2 ways 
# 1. by upoading the img to s3 bucket  then generated link pass to HTTP request maintingn 
# 2. or you can send base64 endcoded string 
# base64-> way convert  an img into a string
import joblib
import json
import numpy as np
import base64
